...
export function SupportSection({
	...
	if (variant === "card")
		return (
			<div className={`h-full rounded-3xl border border-slate-200 bg-white p-6 ${className ?? ""}`}>
				...
				<div className="mt-6">
					<p className="mb-3 text-[0.65rem] font-semibold uppercase tracking-[0.22em] text-red-800">GET SUPPORT</p>
					<p className="text-[clamp(1.35rem,2vw,1.75rem)] font-bold leading-tight tracking-tight text-slate-950">
	...
	return (
		<section aria-label="Get support" className={`bg-slate-50 py-16 lg:py-20 ${className ?? ""}`}>
